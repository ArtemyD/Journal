...
class UiAddClassWindow(object):
    def __init__(self, main_window):
        ...
        self.add_class_window = main_window.add_class_window
        self.add_class_window.setObjectName("MainWindow")
        self.add_class_window.setFixedSize(483, 393)
        self.centralwidget = QtWidgets.QWidget(self.add_class_window)
        self.centralwidget.setObjectName("centralwidget")
        self.dateEdit = QtWidgets.QDateEdit(self.centralwidget)
        self.dateEdit.setGeometry(QtCore.QRect(20, 240, 201, 22))
        self.dateEdit.setObjectName("dateEdit")
        self.comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox.setGeometry(QtCore.QRect(10, 30, 211, 32))
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 280, 181, 16))
        self.label_4.setObjectName("label_4")
        self.dateEdit_2 = QtWidgets.QDateEdit(self.centralwidget)
        self.dateEdit_2.setGeometry(QtCore.QRect(20, 300, 201, 22))
        self.dateEdit_2.setObjectName("dateEdit_2")
        self.comboBox_3 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_3.setGeometry(QtCore.QRect(250, 30, 211, 32))
        self.comboBox_3.setObjectName("comboBox_3")
        ls_3 = ['Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Cуббота']
        self.comboBox_3.addItems(ls_3)
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(260, 10, 81, 16))
        self.label_5.setObjectName("label_5")
        self.comboBox_4 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_4.setGeometry(QtCore.QRect(250, 100, 211, 32))
        self.comboBox_4.setObjectName("comboBox_4")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(260, 80, 111, 16))
        self.label_6.setObjectName("label_6")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(250, 330, 112, 32))
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(self.add)
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(360, 330, 112, 32))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_2.clicked.connect(self.close)
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(260, 150, 101, 16))
        self.label_7.setObjectName("label_7")
        self.comboBox_5 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_5.setGeometry(QtCore.QRect(250, 170, 211, 32))
        self.comboBox_5.setObjectName("comboBox_5")
        self.timeEdit = QtWidgets.QTimeEdit(self.centralwidget)
        self.timeEdit.setGeometry(QtCore.QRect(260, 240, 201, 22))
        self.timeEdit.setObjectName("timeEdit")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(260, 220, 161, 16))
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.centralwidget)
        self.label_9.setGeometry(QtCore.QRect(20, 140, 58, 16))
        self.label_9.setObjectName("label_9")
        self.comboBox_6 = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_6.setGeometry(QtCore.QRect(10, 160, 211, 32))
        self.comboBox_6.setObjectName("comboBox_6")
        self.add_class_window.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(self.add_class_window)
        self.statusbar.setObjectName("statusbar")
        self.add_class_window.setStatusBar(self.statusbar)

        self.retranslateUi(self.add_class_window)
        QtCore.QMetaObject.connectSlotsByName(self.add_class_window)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Добавить периодичное занятие"))
        self.label.setText(_translate("MainWindow", "Формат"))
        self.label_2.setText(_translate("MainWindow", "Дисциплина"))
        self.label_3.setText(_translate("MainWindow", "Дата начала курса"))
        self.label_4.setText(_translate("MainWindow", "Дата завершения курса"))
        self.label_5.setText(_translate("MainWindow", "День недели"))
        self.label_6.setText(_translate("MainWindow", "Периодичность"))
        self.pushButton.setText(_translate("MainWindow", "Добавить"))
        self.pushButton_2.setText(_translate("MainWindow", "Закрыть"))
        self.label_7.setText(_translate("MainWindow", "Аудтория"))
        self.label_8.setText(_translate("MainWindow", "Время начала занятия"))
        self.label_9.setText(_translate("MainWindow", "Группы"))
    ...
    def add(self):
        ...
        o = Occupation()
        o.add(self.session, discipline, format, audience, group, date_begin, date_end, time, weekday, period)
